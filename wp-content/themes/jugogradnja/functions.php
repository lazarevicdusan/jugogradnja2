...
add_action( 'wp_enqueue_scripts', function () {
	...
	// Main stylesheet (generated by block theme — usually empty but needed for child compatibility)
	wp_enqueue_style( 'jugogradnja-style', get_stylesheet_uri(), [], $ver );

	// Theme JS — deferred via wp_script_add_data
	wp_enqueue_script(
		'jugogradnja-main',
	...
	wp_script_add_data( 'jugogradnja-main', 'defer', true );
} );

// Add defer/async attribute support
add_filter( 'script_loader_tag', function ( $tag, $handle ) {
	$scripts_to_defer = [ 'jugogradnja-main' ];
