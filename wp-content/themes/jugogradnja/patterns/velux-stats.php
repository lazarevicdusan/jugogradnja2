...
$stats = [
	[
		...
		'number' => '75+',
		'label'  => __( 'Година искуства', 'jugogradnja' ),
		'desc'   => __( 'VELUX је водећи светски произвођач кровних прозора', 'jugogradnja' ),
	],
	[
		...
		'number' => '11',
		'label'  => __( 'Производних погона', 'jugogradnja' ),
		'desc'   => __( 'У 11 држава широм света, директна продаја у 40 земаља', 'jugogradnja' ),
	],
	[
		// Two people / group
		...
		'number' => '10.000+',
		'label'  => __( 'Запослених', 'jugogradnja' ),
		'desc'   => __( 'Са седиштем компаније у Копенхагену (Данска)', 'jugogradnja' ),
	],
	[
		...
		'number' => '#1',
		'label'  => __( 'Глобални лидер', 'jugogradnja' ),
		'desc'   => __( 'Један од најјачих брендова на тржишту грађевинских материјала', 'jugogradnja' ),
	],
];
?>
<section class="jg-velux-stats">
	<div class="jg-velux-stats__inner">
		<h2 class="jg-velux-stats__heading"><?= esc_html__( 'VELUX - Светски лидер у производњи кровних прозора', 'jugogradnja' ) ?></h2>
		<p class="jg-velux-stats__sub"><?= esc_html__( 'Поседује производне погоне у 11 држава широм света, а директну продају врши у 40 земаља. Представља један од најјачих брендова на глобалном тржишту грађевинских материјала.', 'jugogradnja' ) ?></p>
