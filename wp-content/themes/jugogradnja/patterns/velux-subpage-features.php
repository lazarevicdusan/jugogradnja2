...
$configs = [
	'velux-osnovni' => [
		'desc'     => 'Основни серија VELUX кровних прозора нуди купцима приступачне прозоре без компромиса по питању квалитета. Ова серија пружа све битне функционалности и нуди вам широку понуду: било да желите горње или доње управљање, дрвени или прозор без додатног одржавања.',
		'features' => [
			['icon' => 'box',     'title' => 'Двоструко застакљење', 'desc' => 'Одлична термичка изолација'],
			['icon' => 'options', 'title' => 'Две опције материјала', 'desc' => 'Дрво или полиуретан'],
			['icon' => 'shield',  'title' => '10 година гаранције',  'desc' => 'На све прозоре'],
		],
	],
	'velux-standard' => [
		'desc'     => 'Стандард серија VELUX кровних прозора је идеална за власнике поткровља који су спремни да инвестирају у додатну енергетску ефикасност и комфор. То укључује изузетно приступачно троструко стакло, које вам олакшава да свој дом држите топлим.',
		'features' => [
			['icon' => 'energy',  'title' => 'Троструко застакљење', 'desc' => 'Максимална изолација'],
			['icon' => 'box',     'title' => 'Две опције',            'desc' => 'Дрво или полиуретан'],
			['icon' => 'options', 'title' => 'Уштеда енергије',       'desc' => 'До 30% мање трошкова'],
			['icon' => 'shield',  'title' => '10 година гаранције',   'desc' => 'На све прозоре'],
		],
	],
	'velux-komfor' => [
		'desc'     => 'Комфор серија обухвата панорамске прозоре који пружају непроцењив поглед на природу, као и прозоре на даљинско управљање са електричним или соларним напајањем. Савршено решење за модеран дом.',
		'features' => [
			['icon' => 'panorama',  'title' => 'Панорамски прозори',    'desc' => 'Максимални поглед на природу'],
			['icon' => 'remote',    'title' => 'Даљинско управљање',   'desc' => 'Електро/соларно напајање'],
		],
	],
	'velux-komfor-plus' => [
		'desc'     => 'Комфор Плус серија нуди врхунске кровне прозоре са побољшаним карактеристикама стакла који вам гарантују енергетску ефикасност и модерна решења. Изаберите између обичних, панорамских или електро прозора са сигурносним стаклом.',
		'features' => [
			['icon' => 'touch',    'title' => 'Обични прозори',   'desc' => 'Са сигурносним стаклом'],
			['icon' => 'panorama', 'title' => 'Панорамски',        'desc' => 'Максимални поглед'],
			['icon' => 'remote',   'title' => 'Електро',           'desc' => 'Са сигурносним стаклом'],
		],
	],
];
