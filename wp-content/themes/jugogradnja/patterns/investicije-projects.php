<?php
/**
 * Title: Инвестиције — Наши пројекти
 * Slug: jugogradnja/investicije-projects
...
$projects = [
    [
        'img'      => $t . '/assets/images/photos/proj-arandjelovac.jpg',
    ...
    [
        'img'      => $t . '/assets/images/photos/proj-vladetina22.jpg',
        'title'    => 'Стамбено-пословни објекат „Владетина 22"',
        'location' => 'Београд',
        'year'     => '2024–2025',
        'desc'     => 'Новоградња станова у центру Београда. У мирној улици, на само 400м од парка Мали Ташмајдан.',
    ],
    [
        'img'      => $t . '/assets/images/photos/proj-enmon.jpg',
        'title'    => 'ЕНМОН — Стамбено-пословни објекат',
...
<section class="jg-inv-projects">
  <div class="jg-inv-projects__inner">
    ...
    <div class="jg-inv-projects__grid">
      ...
      <a class="jg-inv-proj-card" href="<?= esc_url( get_permalink( get_page_by_path( 'reference' ) ) ) ?>">
    ...
    <div class="jg-inv-projects__cta">
      <a class="jg-btn jg-btn--gold" href="<?= esc_url( get_permalink( get_page_by_path( 'reference' ) ) ) ?>">
