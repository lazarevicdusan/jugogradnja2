...
$reviews = [
	[
		'initials' => __( 'ГМ', 'jugogradnja' ),
		'name'     => __( 'Горан Миљковић', 'jugogradnja' ),
		'time'     => __( 'пре 3 месеца', 'jugogradnja' ),
		'text'     => __( 'Одлична фирма, професионалци у свом послу. Препоручујем свима који траже квалитет и поштовање рокова.', 'jugogradnja' ),
	],
	[
		'initials' => __( 'МЈ', 'jugogradnja' ),
		'name'     => __( 'Марко Јовановић', 'jugogradnja' ),
		'time'     => __( 'пре 5 месеци', 'jugogradnja' ),
		'text'     => __( 'Врло задовољан сарадњом. Уградња VELUX прозора обављена перфектно, све у договореном року. Топла препорука!', 'jugogradnja' ),
	],
	[
		'initials' => __( 'АП', 'jugogradnja' ),
		'name'     => __( 'Ана Петровић', 'jugogradnja' ),
		'time'     => __( 'пре 6 месеци', 'jugogradnja' ),
		'text'     => __( 'Професионалан тим, одлична комуникација и квалитетна услуга. VELUX прозори су савршено уграђени.', 'jugogradnja' ),
	],
	[
		'initials' => __( 'ИН', 'jugogradnja' ),
		'name'     => __( 'Иван Николић', 'jugogradnja' ),
		'time'     => __( 'пре 8 месеци', 'jugogradnja' ),
		'text'     => __( 'Веома сам задовољан. Уградили су ми кровне прозоре и све је урађено без икаквих проблема. Препорука!', 'jugogradnja' ),
	],
];
?>
<section class="jg-velux-reviews">
	<div class="jg-velux-reviews__inner">
		<h2 class="jg-velux-reviews__heading"><?= esc_html__( 'Шта наши клијенти кажу о VELUX прозорима', 'jugogradnja' ) ?></h2>
		...
		<p class="jg-velux-reviews__count"><?= esc_html__( 'На основу 24 Google рецензија', 'jugogradnja' ) ?></p>
		...
		<div class="jg-velux-reviews__cta">
			<a class="jg-velux-reviews__google-btn" href="https://www.google.com/maps" target="_blank" rel="noopener">
				...
				<?= esc_html__( 'Погледајте све рецензије на Google-у', 'jugogradnja' ) ?>
			</a>
			<div class="jg-velux-reviews__badge">
				...
				<div class="jg-velux-reviews__badge-text">
					<span><?= esc_html__( 'Сертификовани VELUX партнер', 'jugogradnja' ) ?></span>
					<strong><?= esc_html__( 'Више од 15 година искуства', 'jugogradnja' ) ?></strong>
				</div>
			</div>
		</div>
	</div>
