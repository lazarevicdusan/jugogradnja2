...
<section class="jg-velux-reviews">
	<div class="jg-velux-reviews__inner">
		...
		<div class="jg-velux-reviews__grid">
			...
			<div class="jg-velux-reviews__card">
				<div class="jg-velux-reviews__card-header">
					...
					<div>
						<strong class="jg-velux-reviews__name"><?= esc_html( $r['name'] ) ?></strong>
						<div class="jg-velux-reviews__meta">
							<?php for ( $i = 0; $i < 5; $i++ ) : ?>
							<svg width="14" height="14" viewBox="0 0 24 24" fill="#C5A059" aria-hidden="true"><path d="M12 2l2.4 7.4H22l-6.2 4.5 2.4 7.4L12 17l-6.2 4.3 2.4-7.4L2 9.4h7.6L12 2z"/></svg>
							<?php endfor; ?>
		...
		<div class="jg-velux-reviews__badge">
			<svg width="20" height="20" viewBox="0 0 20 20" fill="#C5A059" aria-hidden="true"><path d="M10 1l1.5 4.6H16l-3.7 2.7 1.4 4.6L10 10.5l-3.7 2.4 1.4-4.6L4 5.6h4.5L10 1z"/></svg>
			<div>
