...
$cards = [
	[
		...
		'title' => __( 'Услуге дизајна', 'jugogradnja' ),
		'text'  => __( 'Нудимо подршку која укључује стручне консултације, израду и оптимизацију цртежа као и техничко усклађивање.', 'jugogradnja' ),
	],
	[
		...
		'title' => __( 'Подршка при куповини', 'jugogradnja' ),
		'text'  => __( 'Искусни продајни представници задужени за специфичне земље пружају брзу и висококвалитетну подршку.', 'jugogradnja' ),
	],
	[
		...
		'title' => __( 'Услуге монтаже', 'jugogradnja' ),
		'text'  => __( 'Монтажу врши наш професионални тим који ради по стриктним стандардима произвођача.', 'jugogradnja' ),
	],
	[
		...
		'title' => __( 'Контрола квалитета', 'jugogradnja' ),
		'text'  => __( 'Праћење квалитета производа, чиме се осигурава да сваки комад намештаја испуњава највише стандарде издржљивости.', 'jugogradnja' ),
	],
];
?>
