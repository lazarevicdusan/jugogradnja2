...
<section class="jg-sofeija-partners">
	<div class="jg-sofeija-partners__inner">
		<div class="jg-sofeija-partners__text">
			<h2 class="jg-sofeija-partners__heading"><?= esc_html__( 'Високоефикасна мрежа добављача и партнерства са водећим светским брендовима', 'jugogradnja' ) ?></h2>
			<div class="jg-sofeija-partners__accent"></div>
			<p class="jg-sofeija-partners__body"><?= esc_html__( 'Групација Chinuofeiya бележи изванредне продајне резултате и користи предности великих набавки, што осигурава конкурентне цене. Остварена су партнерства са бројним водећим светским добављачима – специјализованим за плочасте материјале, кант траке, лакове, окове и друго – све у циљу одржавања строге контроле квалитета већ у фази набавке сировина.', 'jugogradnja' ) ?></p>
		</div>
