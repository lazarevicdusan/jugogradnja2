...
<section class="jg-velux-hero">
	...
	<div class="jg-velux-hero__inner">
		...
		<div class="jg-velux-hero__badge">
			...
			<span><?= esc_html__( 'ОВЛАШЋЕНИ ПРОДАВАЦ ОД 1998. ГОДИНЕ', 'jugogradnja' ) ?></span>
		</div>
		<h1 class="jg-velux-hero__heading"><?= esc_html__( 'Дугогодишње партнерство са VELUX-ом', 'jugogradnja' ) ?></h1>
		<p class="jg-velux-hero__sub"><?= esc_html__( 'Прозори који доносе светлост и удобност у ваш дом', 'jugogradnja' ) ?></p>
		<div class="jg-velux-hero__cta">
			<a class="jg-velux-hero__btn jg-velux-hero__btn--gold" href="#prozori"><?= esc_html__( 'ПОНУДА ПРОЗОРА', 'jugogradnja' ) ?></a>
			<a class="jg-velux-hero__btn jg-velux-hero__btn--outline" href="#roletne"><?= esc_html__( 'ПОНУДА РОЛЕТНИ', 'jugogradnja' ) ?></a>
		</div>
		<div class="jg-velux-hero__contacts">
			<div class="jg-velux-hero__contact">
				...
				<div>
					<span class="jg-velux-hero__contact-label"><?= esc_html__( 'Продаја', 'jugogradnja' ) ?></span>
